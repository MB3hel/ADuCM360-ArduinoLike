 ...
 */
/*MODIFIED 8/7/2016 For use with ADUCM360 Boards*/
...
#define SPI pADI_SPI1
#define PORT pADI_GP0
...
private:
	inline static void initSS() { pinMode(0, 3, OUT); };
	inline static void setSS() { digitalWrite(0, 3, LOW); };
	inline static void resetSS() { digitalWrite(0, 3, HIGH); };
